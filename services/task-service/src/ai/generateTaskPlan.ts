...
export async function generateTaskPlan(goal: string): Promise<GeneratedTaskPlan> {
        ...
        input: [
            {
                role: "system",
                content:
                    "You break a user goal into a short list of concrete tasks. Return only actionable tasks. Do not invent people, teams, dates, or dependencies. Keep tasks concise and ordered.",
            },
            {
                role: "user",
